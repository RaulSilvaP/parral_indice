...
<form class="form-horizontal" method="post" action="imprime_revisar2.php" target="_blank">
<fieldset>


<!-- Form Name -->
<legend class="text-center">Imprime índice para revisión</legend>
...
<!--    <button type="button" value="Generar informe" class="btn btn-primary"> -->
    <button type="submit" id="imprimir_revisar" class="btn btn-primary">Generar informe</button>
  </div>
</div>
